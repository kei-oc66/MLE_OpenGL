...
//  2025-11-06: Lower minimum requirement to GLFW 3.0. Though a recent version
//  e.g GLFW 3.4 is highly recommended. 2025-09-18: Call
//  platform_io.ClearPlatformHandlers() on shutdown. 2025-09-15: Content Scales
//  are always reported as 1.0 on Wayland. FramebufferScale are always reported
//  as 1.0 on X11. (#8920, #8921) 2025-07-08: Made
...
#ifndef GLFW_EXPOSE_NATIVE_X11 // for glfwGetX11Display(), glfwGetX11Window() on
...
static void ImGui_ImplGlfw_UpdateGamepads() {
  ...
  if ((io.ConfigFlags & ImGuiConfigFlags_NavEnableGamepad) ==
      0) // FIXME: Technically feeding gamepad shouldn't depend on this now that
         // they are regular inputs, but see #8075
    return;
...
#if GLFW_HAS_X11_OR_WAYLAND
  if (ImGui_ImplGlfw_IsWayland()) // We can't access our bd->IsWayland cache for
                                  // a monitor.
    return 1.0f;
#endif
#if GLFW_HAS_PER_MONITOR_DPI &&                                                \
